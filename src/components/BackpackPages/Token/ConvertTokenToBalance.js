...
export default function ConvertTokenToBalance({ open, setOpen }) {
  ...
  const { mutate: mutationConvertTokenToBalance, isLoading: isLoadingConvert } =
    useMutation({
      mutationFn: (data) => convertTokenToBalance(axiosInstance, data),
      onSuccess: (data) => {
        setOpen(false);
        updateJwtToken(
                ...
                <>
                  <div>
                    ...
                    <div className="mt-3 text-center sm:mt-5">
                      ...
                      >
                        Please input your password to convert your token to
                        balance
                      </Dialog.Title>
                      <div>
                        <label
                      ...
                      <button
                        ...
                        onClick={() => {
                          if (inputToken === "") {
                            ...
                            inputToken > currentUser?.profile.token
                          ) {
                            setIsErrorToken(true);
                            ...
                            setIsErrorToken(true);
                            setErrorTokenMessage(
                              "Maximum Token is 100000"
                            );
                          } else {
                            mutationConvertTokenToBalance({
                              token: inputToken,
                              rateToken: rateToken,
                            });
                          }
